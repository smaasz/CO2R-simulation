...
const bulk = DataFrame(
  ...
  :c_bulk=>[0.09105350460641519,0.091,2.68e-5,0.033,1e-3,10^(pH-14),10^(-pH)]*mol/dm^3,
)
...
# ╔═╡ 06490535-c114-4dc5-9656-3caccd840bf0
let
	df = CSV.read("ringe_concentrations_digitized.csv", DataFrame)
	plot1d(result, celldata, vshow; df_compare = df)
end
...
manifest_format = "2.0"
project_hash = "19bdf0e798f468781077a964a8d36a95e37de0df"
